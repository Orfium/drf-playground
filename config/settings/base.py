...
# drf_playground/
APPS_DIR = ROOT_DIR / "drf_playground"
env = environ.Env()
...
LOCAL_APPS = [
    "drf_playground.users.apps.UsersConfig",
    "drf_playground.common",
    "drf_playground.files"
]
...
MIGRATION_MODULES = {"sites": "drf_playground.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "drf_playground.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Filippos Pavlopoulos""", "philpavlop@gmail.com")]
